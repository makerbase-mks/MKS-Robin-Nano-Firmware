...
//    Endian       =  little
//    Source file  =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano35源码\robin_nano35_v1.0.4_source\Drivers\STM32F1xx_HAL_Driver\Src\stm32f1xx_hal_flash.c
//    Command line =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano35源码\robin_nano35_v1.0.4_source\Drivers\STM32F1xx_HAL_Driver\Src\stm32f1xx_hal_flash.c
...
//    List file    =  
//        E:\code\Robin_Nano_SVN\branches\robin_nano35源码\robin_nano35_v1.0.4_source\EWARM\mksRobinNano/List\stm32f1xx_hal_flash.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  244         CLEAR_BIT(FLASH->CR, FLASH_CR_PG);
        LDR.N    R1,??DataTable10_1  ;; 0x40022010
        LDR      R2,[R1, #+0]
        LSRS     R2,R2,#+1
        LSLS     R2,R2,#+1
        STR      R2,[R1, #+0]
...
//  315   __HAL_FLASH_ENABLE_IT(FLASH_IT_EOP | FLASH_IT_ERR);
        LDR.N    R5,??DataTable10_1  ;; 0x40022010
        LDR      R6,[R5, #+0]
        ORR      R6,R6,#0x1400
        STR      R6,[R5, #+0]
...
//  359   if(__HAL_FLASH_GET_FLAG(FLASH_FLAG_WRPERR) ||__HAL_FLASH_GET_FLAG(FLASH_FLAG_PGERR))
        ...
        LDR.N    R5,??DataTable10_2  ;; 0x4002200c
        LDR      R0,[R5, #+0]
        LSLS     R0,R0,#+27
...
HAL_FLASH_Lock:
        LDR.N    R0,??DataTable10_1  ;; 0x40022010
        LDR      R1,[R0, #+0]
        ORR      R1,R1,#0x80
        STR      R1,[R0, #+0]
//  711   
...
//  821     SET_BIT(FLASH->CR, FLASH_CR_PG);
        LDR.N    R2,??DataTable10_1  ;; 0x40022010
        LDR      R3,[R2, #+0]
        ORR      R3,R3,#0x1
        STR      R3,[R2, #+0]
...
??FLASH_WaitForLastOperation_3:
        LDR      R1,[R0, #+0]
        LSLS     R1,R1,#+27
        BMI.N    ??FLASH_WaitForLastOperation_4
        LDR      R1,[R0, #+16]
        LSLS     R1,R1,#+31
        BMI.N    ??FLASH_WaitForLastOperation_4
        LDR      R0,[R0, #+0]
