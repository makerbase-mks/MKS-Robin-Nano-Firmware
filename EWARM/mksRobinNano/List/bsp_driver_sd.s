...
//    List file    =  
//        D:\MKS-Robin-Nano-Firmware-v2.x.x\MKS-Robin-Nano-Firmware\EWARM\mksRobinNano/List\bsp_driver_sd.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  157 }
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI NoFunction
          CFI NoCalls BSP_SD_ReadBlocks
          CFI NoCalls BSP_SD_WriteBlocks
          CFI NoCalls BSP_SD_Erase
          CFI CFA R13+16
          CFI R14 Frame(CFA, -4)
        THUMB
?Subroutine0:
...
//  172   if(HAL_SD_ReadBlocks_DMA(&hsd, pData, ReadAddr, BlockSize, NumOfBlocks) != SD_OK)  
        ...
        CBNZ.N   R0,??BSP_SD_ReadBlocks_DMA_0
//  173   {
...
//  206   if(HAL_SD_WriteBlocks_DMA(&hsd, pData, WriteAddr, BlockSize, NumOfBlocks) != SD_OK)  
        ...
        CBNZ.N   R0,??BSP_SD_WriteBlocks_DMA_0
//  207   {
...
//  214     if(HAL_SD_CheckWriteOperation(&hsd, (uint32_t)SD_DATATIMEOUT) != SD_OK)  
        ...
        CBZ.N    R0,??BSP_SD_WriteBlocks_DMA_1
//  215     {
...
//  225 }
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI NoFunction
          CFI NoCalls BSP_SD_ReadBlocks_DMA
          CFI NoCalls BSP_SD_WriteBlocks_DMA
          CFI CFA R13+24
          CFI R4 Frame(CFA, -12)
          CFI R5 Frame(CFA, -8)
          CFI R14 Frame(CFA, -4)
